// credits to Thunder04 for this since i wasnt able to figure it out
// https://github.com/thunder04/advent-of-code/blob/main/javascript/2021/day4.mjs
const {readFileSync} = require("fs")
const data = readFileSync(process.cwd() + "/input.txt", { encoding: 'utf8' }).split('\r\n')
